        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="text-[11px] text-[#64748B] dark:text-[#7B9EA8] flex items-center gap-1 truncate max-w-[200px] sm:max-w-none">
                <Building2 className="w-3 h-3 text-[#087F6D] shrink-0" />
                <span>{mockDoctorProfile.hospital} • {mockDoctorProfile.opdRoom}</span>
              </div>
            </div>
          </div>
        </div>
            ...
            {profileDropdownOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-[#0A2020] rounded-2xl border border-[#DDE8E4] dark:border-[#1A3A3A] shadow-xl p-2 z-50 animate-in fade-in zoom-in-95 duration-150">
                <div className="p-2.5 border-b border-[#DDE8E4] dark:border-[#1A3A3A]">
                  <div className="font-bold text-xs text-[#17324D] dark:text-[#E2EEF4]">{doctorName}</div>
                  <div className="text-[10px] text-[#64748B] dark:text-[#7B9EA8]">{t.idLabel}: {mockDoctorProfile.id}</div>
                  <div className="text-[10px] text-[#087F6D] font-mono mt-0.5">{mockDoctorProfile.registrationNumber}</div>
                </div>
