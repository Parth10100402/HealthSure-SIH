...
export const login = async (req, res, next) => {
    try {
        ...
        const user = dataStore.users.find((u) => {
            ...
            const matchRole = !normalizedRole || u.role === normalizedRole || (normalizedRole === 'GOVERNMENT_ADMIN' && u.role === 'ADMIN');
...
export const sendOtp = async (req, res, next) => {
    try {
        ...
        await dataStore.createOrUpdateOtpSession(cleanNumber, otp, config.OTP_EXPIRY_SECONDS, config.OTP_MAX_ATTEMPTS);
