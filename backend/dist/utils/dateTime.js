 ...
 */
export function createUtcInstantFromIst(dateStr, timeStr) {
    if (!dateStr)
 ...
 */
export function formatAppointmentTime(isoStringOrDate) {
    if (!isoStringOrDate)
        return '10:30 AM';
 ...
 */
export function formatAppointmentDate(isoStringOrDate) {
    if (!isoStringOrDate)
        return '2026-08-28';
