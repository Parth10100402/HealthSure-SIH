...
export const getAdminFacilities = async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
export const getAdminReferrals = async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
export const getAdminOutreach = async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
export const getAdminTeleconsultations = async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    res.json({
      success: true,
      data: {
...
export const getAdminFollowUps = async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
